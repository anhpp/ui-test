...
//		assert evt.verifyEventInWeekView(name, getDate(0, "dd/MM/yyyy"), selectDayOption.ONEDAY);
//		assert evt.verifyEventInWeekView(name, getDate(1, "dd/MM/yyyy"), selectDayOption.ONEDAY);
//		assert evt.verifyEventInWeekView(name, getDate(2, "dd/MM/yyyy"), selectDayOption.ONEDAY);
//		assert evt.verifyEventInWeekView(name, getDate(3, "dd/MM/yyyy"), selectDayOption.ONEDAY);
//		assert evt.verifyEventInWeekView(name, getDate(4, "dd/MM/yyyy"), selectDayOption.ONEDAY);

		/*Clear data*/
		info("Clear data");
		evt.deleteRecurringEvent(name, selectDayOption.ONEDAY, recurringType.ALL_EVENT,getDate(0, "dd/MM/yyyy"));
	}
...
//		mouseOver(By.xpath("//*[@id='UIWeekViewGrid']//*[contains(@startfull,'1 2014')]//div[contains(@class,'eventContainerBar eventTitle')]"),true);
...
//		waitForAndGetElement(evt.ELEMENT_RECURRING_TEXT_RECURRING_EVENT);
		Utils.pause(5000);
		waitForAndGetElement(By.xpath((ELEMENT_EVENT_TASK_RECURRING_ICON).replace("${date}", getDate(0, "dd yyyy"))));
...
//		assert evt.verifyEventInWeekView(name, getDate(4, "MMM dd yyyy"), selectDayOption.ALLDAY);
		...
		evt.editRecurringEvent(name,newName,description, null,null,null,true,selectDayOption.ALLDAY,recurringType.ALL_EVENT,getDate(1, "dd/MM/yyyy"));
//		assert evt.verifyEventInWeekView(name, getDate(0, "MMM dd yyyy"), selectDayOption.ALLDAY);
//		assert !evt.verifyEventInWeekView(name, getDate(1, "MMM dd yyyy"), selectDayOption.ALLDAY);
//		assert evt.verifyEventInWeekView(name, getDate(2, "MMM dd yyyy"), selectDayOption.ALLDAY);
//		assert evt.verifyEventInWeekView(name, getDate(3, "MMM dd yyyy"), selectDayOption.ALLDAY);
